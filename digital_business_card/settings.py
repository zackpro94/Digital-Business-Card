"""
Django settings for digital_business_card project.
...
ROOT_URLCONF = 'digital_business_card.urls'
...
WSGI_APPLICATION = 'digital_business_card.wsgi.application'
